...
<div class="dashboard-container">
    <h2>👩‍🏫 Welcome, <?php echo $lecturer_name; ?>! 📘</h2>
    <p>Here’s what you can do:</p>

    <div class="card-container">
        <a href="view_student_answers.php" class="card">
            <h3>📜 View Submissions</h3>
            <p>Review student answers.</p>
        </a>
        <a href="view_student_result.php" class="card">
            <h3>👤 View Results</h3>
            <p>Analyze student exam performance.</p>
        </a>
        <a href="lecturer_profile.php" class="card">
            <h3>👤 Profile</h3>

...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["change_password"])) {
    ...
    if (password_verify($current_password, $stored_password)) {
        if ($new_password === $confirm_password) {
            ...
            $updateStmt->bind_param("ss", $new_hashed, $student_id);
            $updateStmt->execute();
            $updateStmt->close();
...
<div class="container">
    ...
    <div class="profile-info">
        ...
        <div class="profile-data"><?php echo htmlspecialchars($student['student_id']); ?></div>
    </div>
    <div class="profile-info">
        <div class="profile-label">Name:</div>
        <div class="profile-data"><?php echo htmlspecialchars($student['name']); ?></div>
    </div>
    <div class="profile-info">
        <div class="profile-label">Email:</div>
        <div class="profile-data"><?php echo htmlspecialchars($student['email']); ?></div>
    </div>
    <div class="profile-info">
        <div class="profile-label">Phone Number:</div>
        <div class="profile-data"><?php echo htmlspecialchars($student['phone']) ?: '<span class="empty-data">Not provided</span>'; ?></div>
    </div>
    <div class="profile-info">
        <div class="profile-label">Date of Birth:</div>
        <div class="profile-data"><?php echo htmlspecialchars($student['dob']) ?: '<span class="empty-data">Not provided</span>'; ?></div>
    </div>
    <div class="profile-info">
        <div class="profile-label">Address:</div>
        <div class="profile-data"><?php echo htmlspecialchars($student['address']) ?: '<span class="empty-data">Not provided</span>'; ?></div>
    </div>
    <div class="profile-info">
        <div class="profile-label">IC Number:</div>
        <div class="profile-data"><?php echo htmlspecialchars($student['ic_number']) ?: '<span class="empty-data">Not provided</span>'; ?></div>
    </div>
    <div class="profile-info">
        <div class="profile-label">Programme Code:</div>
        <div class="profile-data"><?php echo htmlspecialchars($student['programme_code']) ?: '<span class="empty-data">Not provided</span>'; ?></div>
    </div>
    <div class="profile-info">
    ...
    <div class="btn-container">
        ...
        <a href="student_dashboard.php" class="btn btn-back">⬅️ Back </a>
    </div>
</div>

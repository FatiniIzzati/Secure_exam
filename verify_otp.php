...
// If OTP or student email not set, redirect to login
if (!isset($_SESSION["otp"]) || !isset($_SESSION["student_email"])) {
...
<div class="container">
    ...
    <p class="info">OTP has been sent to your email: <b><?php echo $_SESSION["student_email"]; ?></b></p>
